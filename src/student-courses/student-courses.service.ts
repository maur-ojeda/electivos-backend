...
export class StudentCoursesService {
  ...
  constructor(@Inject('FIRESTORE') private readonly firestore: Firestore) {
    this.collection = this.firestore.collection('student-courses');
  }
  async create(createCourseDto: CreateStudentCourseDto) {
    try {
  ...
  async update(id: string, updateCourseDto: UpdateStudentCourseDto) {
